...
def lpips(x: torch.Tensor, y: torch.Tensor, net='vgg'):  # for computing loss, use alex, faster
    # B, 3, H, W
    # B, 3, H, W
    ...
    return lpips.net_map[net](x.cuda(), y.cuda()).mean()
