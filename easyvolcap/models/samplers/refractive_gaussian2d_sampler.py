...
from easyvolcap.utils.refractive_optix_utils import HardwareRendering
...
from easyvolcap.utils.refractive_gaussian2d_utils import GaussianModel, render, prepare_gaussian_camera
...
class RefractiveGaussian2DSampler(VolumetricVideoModule):
    def __init__(self,
                 # Legacy APIs
                 ...
                 init_refraction: float = 0.5,  # refraction initialization TBD 1e-3
                 ...
                 render_refraction: bool = False,  # default is False here
                 ...
                 max_gs: int = 1e6,  # control the maximum number of gaussians
        ...
        # Refraction rendering configs
        self.render_refraction = render_refraction
        ...
        self.pcd = GaussianModel(
            ...
            init_refraction=self.init_refraction,
            max_gs=self.max_gs,
        ...
        if self.use_optix_tracing:
            self.diffop = HardwareRendering() #for reflection(environment) gaussian ray tracing.
            self.diffop_refracted = HardwareRendering() #TBD : this is for refracted gaussians ray tracing. Error occurs if you use same tracer on reflection&refraction.
